...
<?endif?>
				<input type="password" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off" placeholder="<?=getMessage("PASSWORD_PLACEHOLDER");?>" />
				<label class="bx-authform-label-container"><?=$arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></label>
			</div>
		</div>
...
<?endif?>
				<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off" placeholder="<?=getMessage("PASSWORD_PLACEHOLDER");?>" />
			</div>
		</div>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" placeholder="<?= getMessage("EMAIL_PLACEHOLDER");?>" />
			</div>
		</div>
