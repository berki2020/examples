...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<figure class="news_item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
				<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img src="<?=$arItem["PREVIEW_PICTURE"]["SRC"] ?? MY_DEFAULT_TEMPLATE_PATH . 'images/no-image.jpg'?>" alt="<?=$arItem["PREVIEW_PICTURE"]["ALT"]?>" title="<?=$arItem["PREVIEW_PICTURE"]["TITLE"]?>"/></a>
